...
# Struct
# Struct is a special Ruby class whose job is to generate other classes.
...
# We have to use Object.send(:remove_const, :NAME) instead of just Object.remove_ const(:NAME), because remove_const is a private method that ordinarily can only be called by sending a message from inside the Object class itself; using Object.send allows us to bypass this restriction temporarily.
