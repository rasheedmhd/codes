...
var $author$project$PhotoGroove$createThumbnailUrl = function (thumbnail) {
	return A2(
		$elm$html$Html$img,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$src(
				_Utils_ap($author$project$PhotoGroove$urlprefix, thumbnail.url))
			]),
		_List_Nil);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$map, $author$project$PhotoGroove$createThumbnailUrl, model))
			]));
};
